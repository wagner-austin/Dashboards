...
For a master's Charter on restraint reduction or emergency behavioral medication reduction, H.R. 4407 belongs in the "policy context" or "sustainability" section, not the intervention design. The bill signals federal recognition of the workforce-fragility problem but doesn't fund the QI infrastructure a unit-level project would need.
