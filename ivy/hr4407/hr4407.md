...
**Senate companion:** S.1482 ([Blunt Rochester D-DE, introduced 10 April 2025](https://www.govinfo.gov/content/pkg/BILLS-119s1482is/pdf/BILLS-119s1482is.pdf)); HELP Committee hearings 19 March 2026  
...
This is a primary-source brief on H.R. 4407 (119th Congress). Every factual claim is anchored to the bill text (govinfo GPO PDF), the Congress.gov status page, the sponsor's press release, or the identical Senate companion S.1482. Numerical claims (dollar caps, non-federal match, cosponsor counts, dates) trace to a specific primary source cited inline; downstream text should link to those primaries, not to this document.
...
Inadequate staffing and burned-out staff are documented risk factors for restrictive-practice use in inpatient psychiatric care — see the Implementation Fidelity literature summarised at https://austinwagner.org/ivy/de-escalation/#implementation-fidelity ([Price 2015 systematic review](https://doi.org/10.1192/bjp.bp.114.144576); [Heckemann 2015](https://doi.org/10.1016/j.nedt.2014.08.003); Hamilton 2016 failed Safewards replication; [Duxbury 2019 REsTRAIN Yourself](https://doi.org/10.1111/inm.12577)). H.R. 4407 is the workforce-policy backdrop for that literature.
