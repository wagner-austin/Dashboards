...
function stackFrom(world, actor, foreground) {
    return {
...
describe("occludeStackedBuffers", () => {
    ...
    it("reproduces the single-buffer result cell for cell", () => {
        ...
        const buffers = stackFrom(["TT.T", "T..T"], [" RR ", " R  "], ["  G ", "GG  "]);
        occludeStackedBuffers(buffers);
...
//# sourceMappingURL=occlusion.test.js.map