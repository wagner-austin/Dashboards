 ...
 */
export function getParallaxX(entityX, cameraX, parallax) {
 ...
 */
export function renderLayer(buffer, layer, cameraX, viewportWidth, viewportHeight) {
 ...
 */
export function renderAllLayers(buffer, scene, viewportWidth, viewportHeight) {
 ...
 */
function renderTiledForeground(buffer, entity, cameraX, parallax, viewportWidth, viewportHeight) {
    const frame = getSceneSpriteFrame(entity);
    if (frame === null)
        return;
 ...
 */
export function renderForegroundLayer(buffer, layer, cameraX, viewportWidth, viewportHeight) {
    const parallax = layer.config.parallax;
 ...
 */
export function renderForegroundLayers(buffer, scene, viewportWidth, viewportHeight) {
    for (const layer of scene.layers) {
        if (layer.config.name.includes("front")) {
