...
describe("validateSpriteModule", () => {
    ...
    it("throws for non-object", () => {
        expect(() => validateSpriteModule(null, "test.js")).toThrow("Invalid sprite module at test.js: not an object");
        expect(() => validateSpriteModule("string", "test.js")).toThrow("Invalid sprite module at test.js: not an object");
    });
    it("throws for missing frames", () => {
        expect(() => validateSpriteModule({}, "test.js")).toThrow("Invalid sprite module at test.js: frames must be string array");
    });
    it("throws for non-string frames", () => {
        expect(() => validateSpriteModule({ frames: [1, 2, 3] }, "test.js")).toThrow("Invalid sprite module at test.js: frames must be string array");
    });
});
