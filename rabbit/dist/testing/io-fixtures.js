 ...
 */
export function createTestAnimation(directional, width) {
    return {
 ...
 */
export function createTestAnimations() {
    return {
 ...
 */
export function createTestConfig(characters = ["bunny"]) {
    const sprites = {
 ...
 */
export function createTestValidatedLayer(name, spriteNames) {
    return {
        name,
        type: "tile",
        layer: 6,
...
//# sourceMappingURL=io-fixtures.js.map