 ...
 */
export function isHopping(state) {
 ...
 */
export function isJumping(state) {
 ...
 */
export function isWalking(state) {
 ...
 */
export function getHopDirection(state) {
