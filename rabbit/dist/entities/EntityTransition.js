 ...
 */
export function createTransitionState(sizeIdx) {
    return {
        sizeIdx,
 ...
 */
export function updateSizeTransition(state, deltaTimeMs, transitionDurationMs) {
 ...
 */
export function updateVisibilityFade(state, isVisible, deltaTimeMs, fadeDurationMs) {
 ...
 */
export function shouldDrawEntity(state) {
 ...
 */
export function isEntityInForeground(state, sizeCount) {
    if (sizeCount <= 1) {
        return false;
    }
...
//# sourceMappingURL=EntityTransition.js.map