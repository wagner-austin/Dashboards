...
const ASSETS = { companion: createTestFrames(), alertLeft: ["lowL", "highL"], alertRight: ["lowR", "highR"], lionSprint: { left: ["runL"], right: ["runR"] } };
...
//# sourceMappingURL=Adventure.test.js.map