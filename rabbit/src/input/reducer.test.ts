...
import { NEUTRAL_INTENT, createIntent, type MovementIntent } from "./intent.js";
...
describe("applyIntentChange", () => {
   ...
   */
  function apply(previous: MovementIntent, next: MovementIntent): void {
    state.intent = next;
   ...
   */
  function setAnimation(animation: AnimationState): void {
