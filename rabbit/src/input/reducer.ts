 ...
 */
function applyVerticalChange(
  previous: MovementIntent,
  next: MovementIntent,
  state: InputState,
  timers: BunnyTimers
): void {
  const isHorizontalHeld = (): boolean => isHorizontalRequested(state);
 ...
 *     timers: Bunny animation timers.
 */
function applyHorizontalChange(
  previous: MovementIntent,
  next: MovementIntent,
  state: InputState,
  frames: BunnyFrames,
 ...
 *     timers: Bunny animation timers.
 */
export function applyIntentChange(
  previous: MovementIntent,
  next: MovementIntent,
  state: InputState,
  frames: BunnyFrames,
