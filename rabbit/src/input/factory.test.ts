...
import { _test_hooks, type InputSystem } from "./factory.js";
...
describe("createInputSystem", () => {
  ...
  let keyboardEvents: TestKeyboardSource;
  let touchEvents: TestTouchSource;
  ...
  it("never engages when autorun is disabled", () => {
    const disabled: AutorunConfig = { ...WALK_RIGHT, enabled: false };
