...
Alert/attentive crouching bunny animation.

## Frames

6 frames (frame_0 to frame_5), ping-pong animation = 10 total frames in GIF.
...
```bash
cd originals/bunny/bunny_alert
python -c "
...
pingpong_frames[0].save('bunny_alert.gif', save_all=True, append_images=pingpong_frames[1:],
