...
| first 14 articles, 8 source pages stale, every one high confidence | public-dashboards § Research write-ups, the table | me-wiki log since 2026-09-10 (`7151d84`, `99c7af0`, `46329d3`, `e3eea68`, `61b3fc6`, `6d05bc6`) plus MCPs `987b37ac`; each page's frontmatter read `confidence: high` before its fix | **stale, fixed**: article said four; the count is a running tally and the page says so |
